    ...
    <Card className="w-full">
      ...
      <CardContent>
              ...
              {payerData.map((payer, index) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm text-right text-slate-700">
                    {payer.totalPolicies.toLocaleString("en-US")}
                  </td>
                  <td className="p-3 text-sm text-right text-slate-700">
                    {payer.hcpcsCodes.toLocaleString("en-US")}
                  </td>
                  <td className="p-3 text-sm text-right text-slate-700">
                    {payer.modifiers.toLocaleString("en-US")}
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="mt-4 text-xs text-muted-foreground">
          <p>
            * Data represents current policy coverage metrics across major
            healthcare payers
          </p>
        </div>
      </CardContent>

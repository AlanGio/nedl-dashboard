...
export function WrittenPolicyCoverageTable() {
  return (
    <Card className="shadow-custom">
      <CardHeader>
        <CardTitle className="text-lg font-semibold text-slate-800">Written Policy Coverage by Payer</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200">
                <th className="text-left py-3 px-4 font-semibold text-slate-700">Payer Name</th>
                <th className="text-right py-3 px-4 font-semibold text-slate-700">Total Policies</th>
                <th className="text-right py-3 px-4 font-semibold text-slate-700">HCPCS Codes Covered</th>
                <th className="text-right py-3 px-4 font-semibold text-slate-700">Modifiers Covered</th>
              </tr>
            </thead>
            <tbody>
